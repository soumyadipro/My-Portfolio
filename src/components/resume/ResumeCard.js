  ...
  return (
    <div className="w-full py-6 flex flex-col gap-2.5 border-b-[1px] border-b-zinc-800">
      {badge === "" ? (
        ...
        <h6 className="w-26 text-center text-sm py-[1px] text-[#999] border-[1px] border-zinc-600 rounded-sm">
          {badge}
        </h6>
      )}
      ...
      <p className="text-sm text-[#999] font-small text-justify pr-10" >{des}</p>
    </div>
  );
};
